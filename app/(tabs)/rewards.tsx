...
import { StyleSheet, Text, View, TouchableOpacity, ImageBackground, Alert, Animated } from 'react-native';
...
export default function RewardsTabScreen() {
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      <ImageBackground 
        source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXBpWo-LiqRFjS004-m8WPN0GP-sqkJHIKBA&s' }} 
...
const styles = StyleSheet.create({
  ...
  // Background image setup, takes up full screen
  background: {
    flex: 1, 
    width: '100%', 
    justifyContent: 'center', 
